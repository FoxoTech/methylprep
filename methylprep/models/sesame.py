...
class Sesame():
    ...
    def test_dye_bias(self):
        ...
        # recalculate beats with dye correction and compare
        def calculate_beta_value(methylated_noob, unmethylated_noob, offset=0):
        ...
        # methylprep.processing.postprocess.calculate_beta_value
        input_dataframe = self.containers[0]._SampleDataContainer__data_frame
        self.containers[0]._postprocess(input_dataframe, calculate_beta_value, 'beta_value')
